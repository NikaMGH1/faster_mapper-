...
gcc -std=c99  -fopenmp par_2_omp_r.c -o par_2_omp_r 
gcc -std=c99  -fopenmp par_1_omp_r.c -o par_1_omp_r 
gcc -std=c99  -fopenmp par_2_omp_d.c -o par_2_omp_d 
gcc -std=c99  -fopenmp par_1_omp_d.c -o par_1_omp_d
